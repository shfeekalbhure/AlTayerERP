...
CREATE TABLE `document_links` (
    `document_link_id` bigint NOT NULL AUTO_INCREMENT,
    `from_module_id` int NOT NULL,
    `from_document_type_id` int NOT NULL,
    ...
    `to_document_type_id` int NOT NULL,
...
CREATE TABLE `numbering_document_types` (
    `numbering_document_type_id` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `payment_methods` (
    ...
    `requires_reference_date` tinyint(1) NOT NULL,
...
CREATE TABLE `tenant_groups` (
    ...
    `show_in_login` tinyint(1) NOT NULL DEFAULT TRUE,
    `show_in_tree` tinyint(1) NOT NULL DEFAULT TRUE,
    `sort_order` int NOT NULL,
    `notes` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
    `created_at` datetime(6) NOT NULL,
    `updated_at` datetime(6) NULL,
...
CREATE TABLE `voucher_statuses` (
    `voucher_status_id` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `role_permissions` (
    ...
    `can_un_approve` tinyint(1) NOT NULL,
...
CREATE TABLE `account_code_settings` (
    ...
    `parent_based` tinyint(1) NOT NULL,
    `auto_generate` tinyint(1) NOT NULL,
    `allow_manual_code` tinyint(1) NOT NULL,
    `max_serial` int NOT NULL,
    `is_active` tinyint(1) NOT NULL,
    `created_at` datetime(6) NOT NULL,
...
CREATE TABLE `chart_of_accounts` (
    ...
    `notes` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
    `allow_manual_entry` tinyint(1) NOT NULL,
    `system_account` tinyint(1) NOT NULL,
    `requires_cost_center` tinyint(1) NOT NULL,
    `requires_party` tinyint(1) NOT NULL,
    `requires_project` tinyint(1) NOT NULL,
    `is_summary_account` tinyint(1) NOT NULL,
    `affects_balance_sheet` tinyint(1) NOT NULL,
    `affects_income_statement` tinyint(1) NOT NULL,
    `multi_currency` tinyint(1) NOT NULL,
    `is_control_account` tinyint(1) NOT NULL,
...
CREATE TABLE `currencies` (
    ...
    `min_exchange_rate` decimal(18,6) NULL,
    `max_exchange_rate` decimal(18,6) NULL,
    `is_local_currency` tinyint(1) NOT NULL,
    `is_default` tinyint(1) NOT NULL,
    `is_active` tinyint(1) NOT NULL,
    `notes` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
    `created_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
...
CREATE TABLE `exchange_rates` (
    ...
    `company_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
    `currency_code` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
    `rate_date` datetime(6) NOT NULL,
    `exchange_rate_value` decimal(18,6) NOT NULL,
...
CREATE TABLE `tenant_branches` (
    ...
    `manager_name` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
    `notes` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
    `allow_credit` tinyint(1) NOT NULL,
    `allow_percentage` tinyint(1) NOT NULL,
    `is_active` tinyint(1) NOT NULL DEFAULT TRUE,
...
CREATE TABLE `cash_boxes` (
    ...
    `min_limit` decimal(19,4) NOT NULL,
    `is_active` tinyint(1) NOT NULL,
    `notes` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
    `created_at` datetime(6) NOT NULL,
    `updated_at` datetime(6) NULL,
...
CREATE TABLE `financial_voucher_headers` (
    ...
    `voucher_date` datetime(6) NOT NULL,
    ...
    `foreign_total` decimal(18,2) NOT NULL,
    `local_total` decimal(18,2) NOT NULL,
...
CREATE TABLE `document_allocations` (
    ...
    `currency_id` int NOT NULL,
    `exchange_rate` decimal(18,6) NOT NULL,
    `document_total` decimal(18,2) NOT NULL,
    `collected_before` decimal(18,2) NOT NULL,
    `collected_now` decimal(18,2) NOT NULL,
...
CREATE TABLE `financial_voucher_details` (
    `voucher_detail_id` bigint NOT NULL AUTO_INCREMENT,
    `voucher_id` bigint NOT NULL,
...
CREATE TABLE `payment_requests` (
    ...
    `description` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
    `approved_local_total` decimal(19,4) NOT NULL,
...
CREATE TABLE `voucher_action_logs` (
    `voucher_action_id` bigint NOT NULL AUTO_INCREMENT,
    `voucher_id` bigint NOT NULL,
...
CREATE TABLE `user_permissions` (
    ...
    `can_export` tinyint(1) NOT NULL,
    `can_import` tinyint(1) NOT NULL,
    `can_preview` tinyint(1) NOT NULL,
    `can_approve` tinyint(1) NOT NULL,
    `can_un_approve` tinyint(1) NOT NULL,
...
CREATE TABLE `payment_request_attachments` (
    `payment_request_attachment_id` bigint NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `payment_request_lines` (
    `payment_request_line_id` bigint NOT NULL AUTO_INCREMENT,
    `payment_request_id` bigint NOT NULL,
    `line_no` int NOT NULL,
    `account_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
    `cost_center_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
    ...
    `foreign_amount` decimal(19,4) NOT NULL,
