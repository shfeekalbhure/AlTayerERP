...
partial class CountriesForm
{
    ...
    private void InitializeComponent()
    {
        ...
        lblPhoneKey = new Label(); txtPhoneKey = new TextBox(); lblCurrency = new Label(); cmbCurrency = new ComboBox();
        ...
        statusStripSystem = new StatusStrip(); lblCompanyStatus = new ToolStripStatusLabel(); lblBranchStatus = new ToolStripStatusLabel(); lblYearStatus = new ToolStripStatusLabel(); lblUserStatus = new ToolStripStatusLabel(); lblApiStatus = new ToolStripStatusLabel(); lblDbStatus = new ToolStripStatusLabel();
        ...
        mainTableLayout.RowStyles.Add(new RowStyle(SizeType.Absolute, 45F)); mainTableLayout.RowStyles.Add(new RowStyle(SizeType.Absolute, 180F)); mainTableLayout.RowStyles.Add(new RowStyle(SizeType.Absolute, 50F)); mainTableLayout.RowStyles.Add(new RowStyle(SizeType.Percent, 100F)); mainTableLayout.RowStyles.Add(new RowStyle(SizeType.Absolute, 95F));
        ...
        tblDataCard.Dock = DockStyle.Fill; tblDataCard.ColumnCount = 4; tblDataCard.RowCount = 5; tblDataCard.Padding = new Padding(8);
        ...
        for (var r = 0; r < 5; r++) tblDataCard.RowStyles.Add(new RowStyle(SizeType.Absolute, 28F));
        ...
        lblNotes.Text = "ملاحظات:"; ConfigureLabel(lblNotes); txtNotes.Dock = DockStyle.Fill; txtNotes.Multiline = true; tblDataCard.Controls.Add(lblNotes, 0, 4); tblDataCard.Controls.Add(txtNotes, 1, 4); tblDataCard.SetColumnSpan(txtNotes, 3);
        ...
        statusStripSystem.Dock = DockStyle.Bottom; statusStripSystem.Items.AddRange(new ToolStripItem[] { lblCompanyStatus, lblBranchStatus, lblYearStatus, lblUserStatus, lblApiStatus, lblDbStatus });
        ...
        Controls.Add(mainTableLayout); Controls.Add(statusStripSystem); ((System.ComponentModel.ISupportInitialize)numDisplayOrder).EndInit(); ((System.ComponentModel.ISupportInitialize)dgvCountries).EndInit(); ResumeLayout(false); PerformLayout();
    }
    ...
    private TableLayoutPanel mainTableLayout = null!; private FlowLayoutPanel panelButtons = null!; private Button btnNew = null!, btnSave = null!, btnEdit = null!, btnCancel = null!, btnReset = null!, btnRefresh = null!, btnSearch = null!, btnPrint = null!, btnClose = null!;
