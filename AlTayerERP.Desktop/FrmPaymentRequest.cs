...
public sealed class FrmPaymentRequest : BaseForm
{
    ...
    private void NewRequest(){_id=0;_status="DRAFT";_paymentVoucherId=null;ApplyWorkflowState();_number.Clear();_beneficiary.Clear();_party.Clear();_paymentMethod.Clear();_reference.Clear();_description.Clear();_reason.Clear();_cash.Clear();_lines.Rows.Clear();_lines.Rows.Add();_lines.Rows.Add();}
